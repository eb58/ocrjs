...
const generateDBsForEBData = function (dimr, dimc) {
   ...
   fs.writeFileSync(`data/dbjs/ebdb-train-${dimstr}.js`, 'module.exports = ' + JSON.stringify(genEBDB(traindata, dimr, dimc)));
   fs.writeFileSync(`data/dbjs/ebdb-test-${dimstr}.js`, 'module.exports = ' + JSON.stringify(genEBDB(testdata, dimr, dimc)));
}
